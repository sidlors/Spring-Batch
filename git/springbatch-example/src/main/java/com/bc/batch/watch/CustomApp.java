...
public class CustomApp {
	public static void main(String[] args) {
		CustomApp obj = new CustomApp();
		obj.runTest();
	}

	private void runTest() {

		String[] springConfig = { "spring/batch/jobs/job-customWriter.xml" };
		...
		try {
			JobParameters param = new JobParametersBuilder().addString("requestId", "3866")
